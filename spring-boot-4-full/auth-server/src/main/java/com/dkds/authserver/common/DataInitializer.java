...
public class DataInitializer {
    ...
    public void initializeData() {
        ...
        OrgSecurityPolicy policy1 = OrgSecurityPolicy.builder()
                .orgId(org1.getId())
        ...
        Membership membership2a = Membership.builder()
                .user(user2)
                .organization(org2)
                .active(true)
                .build();
        ...
        OrgSecurityPolicy policy2 = OrgSecurityPolicy.builder()
                .orgId(org2.getId())
                .mfaMode(MfaMode.NEVER)
                .ipRestrictionEnabled(false)
                .build();
        ...
        Membership membership2b = Membership.builder()
                .user(user2)
                .organization(org3)
                .active(true)
                .build();
        ...
        OrgSecurityPolicy policy3 = OrgSecurityPolicy.builder()
                .orgId(org3.getId())
        ...
        Membership membership2c = Membership.builder()
                .user(user2)
                .organization(org4)
                .active(true)
                .build();
        ...
        OrgSecurityPolicy policy4 = OrgSecurityPolicy.builder()
                .orgId(org4.getId())
        ...
        Organization orgAdmin = Organization.builder()
                .code("ORG_ADMIN")
        ...
        Membership membershipAdmin = Membership.builder()
                .user(admin)
        ...
        OrgSecurityPolicy policyAdmin = OrgSecurityPolicy.builder()
        ...
        Organization orgIpRestricted = Organization.builder()
        ...
        OrgSecurityPolicy policyIpRestricted = OrgSecurityPolicy.builder()
        ...
        OrgIpRange ipRange1 = OrgIpRange.builder()
                .organization(orgIpRestricted)
                .cidr("192.168.1.0/24")
                .build();
        orgIpRangeRepository.save(ipRange1);

        OrgIpRange ipRange2 = OrgIpRange.builder()
                .organization(orgIpRestricted)
                .cidr("10.0.0.0/8")
                .build();
        ...
        Organization orgSso = Organization.builder()
                .code("ORG_SSO")
        ...
        OrgSecurityPolicy policySso = OrgSecurityPolicy.builder()
                .orgId(orgSso.getId())
                .mfaMode(MfaMode.NEVER)
                .ipRestrictionEnabled(false)
                .build();
        ...
        UserVerification user1EmailVerif = UserVerification.builder()
                .user(user1)
                .method("EMAIL")
        ...
        UserVerification user2EmailVerif = UserVerification.builder()
                .user(user2)
                .method("EMAIL")
                .verifiedAt(Instant.now())
                .build();
